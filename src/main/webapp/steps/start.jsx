...
export default ({ step, config }) => {
    return (
        <div>
            ...
            <List>
                <List.Item>
                    Splunk App for Lookup File Editing is required on the source and destination
                    system to migrate Lookups
                </List.Item>
                <List.Item>
                    Authentication to a user in Splunk Cloud with the sc_admin role is required
                </List.Item>
                <List.Item>
                    Config modifications in app default directories will be migrated into local
                    (except for private apps)
                </List.Item>
            </List>
        </div>
    );
